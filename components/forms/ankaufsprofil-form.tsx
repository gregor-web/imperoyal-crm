...
function MultiSelectChips({
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-[#EDF1F5] mb-2">{label}</label>
  ...
  return (
    <div className="border border-white/[0.08] rounded-lg overflow-hidden">
      <button
        ...
        className="w-full px-4 py-3 bg-[#162636] flex items-center justify-between text-left hover:bg-[#253546] transition-colors"
      >
        <span className="font-semibold text-[#EDF1F5]">{title}</span>
        {isOpen ? (
          <ChevronUp className="w-5 h-5 text-[#7A9BBD]" />
        ) : (
          <ChevronDown className="w-5 h-5 text-[#7A9BBD]" />
        )}
      </button>
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      <Section title="2.1 Allgemeine Ankaufsparameter" defaultOpen={!compact}>
        ...
        <div className="flex items-center gap-3">
          <label className="text-sm font-medium text-[#EDF1F5]">Kaufinteresse aktiv?</label>
      ...
      <Section title="2.2 Standortprofil" defaultOpen={!compact}>
        ...
        <div>
          ...
          <textarea
            {...register('regionen')}
            rows={2}
            className="glass-input w-full px-4 py-2.5 rounded-lg text-[#EDF1F5] placeholder-[#9EAFC0] focus:outline-none focus:ring-2 focus:ring-[#7A9BBD]"
      ...
      <Section title="2.5 Zusätzliche Angaben" defaultOpen={!compact}>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <label className="text-sm font-medium text-[#EDF1F5]">
