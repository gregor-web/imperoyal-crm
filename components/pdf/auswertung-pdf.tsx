...
const ProgressBar = ({
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
      ...
      {showLabel && (
        <Text style={{ fontSize: 8, color: '#4a7ab0', width: 30, textAlign: 'right' }}>
...
const ComparisonBar = ({
  ...
  soll,
  label,
  colorIst = '#8ab4d8', // Blue Bone lighter
  colorSoll = '#22c55e',
}: {
  ist: number;
  soll: number;
  ...
  return (
    <View style={{ marginBottom: 8 }}>
      <Text style={{ fontSize: 7, color: '#4a7ab0', marginBottom: 3 }}>{label}</Text>
      <View style={{ gap: 2 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
          <Text style={{ fontSize: 6, color: '#8ab4d8', width: 20 }}>IST</Text>
...
const TrendArrow = ({
  ...
  const arrowColor = direction === 'up' ? '#22c55e' : direction === 'down' ? '#ef4444' : '#8ab4d8';
...
// Color constants
// Imperoyal Brand Colors (satter/blauer)
const colors = {
  // Brand Primary - Royal Navy (kräftiger)
  primary: '#1a3a6e',
  // Brand Secondary - Growth Blue (blauer)
  primaryLight: '#4a7ab0',
  // Brand Tertiary - Blue Bone (blauer)
  blueBone: '#8ab4d8',
        ...
        {berechnungen?.marktdaten && (
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
              ...
              <Text style={{ fontSize: 7, color: '#4a7ab0', marginLeft: 'auto' }}>
            ...
            <View style={{ flexDirection: 'row', gap: 8 }}>
              ...
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#4a7ab0' }}>Vergleichsmiete Wohnen</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1a3a6e' }}>
                    {berechnungen.marktdaten.vergleichsmiete_wohnen.wert} €/m²
                  </Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#4a7ab0' }}>Vergleichsmiete Gewerbe</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1a3a6e' }}>
                    {berechnungen.marktdaten.vergleichsmiete_gewerbe.wert} €/m²
                  </Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#4a7ab0' }}>Kaufpreisfaktor Region</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1a3a6e' }}>
              ...
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#4a7ab0' }}>Kappungsgrenze</Text>
                  <Text style={{
                    fontSize: 7,
                    fontWeight: 'bold',
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#4a7ab0' }}>Milieuschutz</Text>
                  <Text style={{
                    fontSize: 7,
                    fontWeight: 'bold',
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#4a7ab0' }}>Akt. Bauzinsen</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1a3a6e' }}>
        ...
        <View style={styles.sectionRow}>
          ...
          <View style={styles.sectionBox}>
            ...
            <View style={styles.sectionContent}>
              ...
              <View style={{ marginBottom: 8 }}>
                {[
                  { label: 'Instandhaltung', value: kosten?.instandhaltung || 0, color: '#4a7ab0' },
          ...
          <View style={styles.sectionBox}>
            ...
            <View style={styles.sectionContent}>
              ...
              <View style={{ marginBottom: 10 }}>
                {[
                  { label: 'Brutto-Rendite IST', value: rendite?.rendite_ist || 0, color: '#8ab4d8' },
