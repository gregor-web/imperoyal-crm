...
const ProgressBar = ({
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
      ...
      {showLabel && (
        <Text style={{ fontSize: 8, color: '#5c7a9a', width: 30, textAlign: 'right' }}>
...
const ComparisonBar = ({
  ...
  soll,
  label,
  colorIst = '#9fb4c8', // Blue Bone lighter
  colorSoll = '#22c55e',
}: {
  ist: number;
  soll: number;
  ...
  return (
    <View style={{ marginBottom: 8 }}>
      <Text style={{ fontSize: 7, color: '#5c7a9a', marginBottom: 3 }}>{label}</Text>
      <View style={{ gap: 2 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
          <Text style={{ fontSize: 6, color: '#9fb4c8', width: 20 }}>IST</Text>
...
const TrendArrow = ({
  ...
  const arrowColor = direction === 'up' ? '#22c55e' : direction === 'down' ? '#ef4444' : '#9fb4c8';
...
// Color constants
// Imperoyal Brand Colors (oberste Reihe der Farbpalette)
const colors = {
  // Brand Primary - Royal Navy (oberste Farbe)
  primary: '#1e3a5f',
  // Brand Secondary - Growth Blue (oberste Farbe)
  primaryLight: '#5c7a9a',
  // Brand Tertiary - Blue Bone (oberste Farbe)
  blueBone: '#9fb4c8',
  // Text colors (basierend auf Brand Farben)
  text: '#1e3a5f',
  textMuted: '#5c7a9a',
  textLight: '#9fb4c8',
        ...
        {berechnungen?.marktdaten && (
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
              ...
              <Text style={{ fontSize: 7, color: '#5c7a9a', marginLeft: 'auto' }}>
            ...
            <View style={{ flexDirection: 'row', gap: 8 }}>
              ...
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#5c7a9a' }}>Vergleichsmiete Wohnen</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1e3a5f' }}>
                    {berechnungen.marktdaten.vergleichsmiete_wohnen.wert} €/m²
                  </Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#5c7a9a' }}>Vergleichsmiete Gewerbe</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1e3a5f' }}>
                    {berechnungen.marktdaten.vergleichsmiete_gewerbe.wert} €/m²
                  </Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#5c7a9a' }}>Kaufpreisfaktor Region</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1e3a5f' }}>
              ...
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#5c7a9a' }}>Kappungsgrenze</Text>
                  <Text style={{
                    fontSize: 7,
                    fontWeight: 'bold',
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#5c7a9a' }}>Milieuschutz</Text>
                  <Text style={{
                    fontSize: 7,
                    fontWeight: 'bold',
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 }}>
                  <Text style={{ fontSize: 7, color: '#5c7a9a' }}>Akt. Bauzinsen</Text>
                  <Text style={{ fontSize: 7, fontWeight: 'bold', color: '#1e3a5f' }}>
        ...
        <View style={styles.sectionRow}>
          ...
          <View style={styles.sectionBox}>
            ...
            <View style={styles.sectionContent}>
              ...
              <View style={{ marginBottom: 8 }}>
                {[
                  { label: 'Instandhaltung', value: kosten?.instandhaltung || 0, color: '#5c7a9a' },
          ...
          <View style={styles.sectionBox}>
            ...
            <View style={styles.sectionContent}>
              ...
              <View style={{ marginBottom: 10 }}>
                {[
                  { label: 'Brutto-Rendite IST', value: rendite?.rendite_ist || 0, color: '#9fb4c8' },
