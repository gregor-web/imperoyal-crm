        ...
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-semibold text-slate-800 text-sm">Automatischer Käufer-Abgleich</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-semibold text-slate-800 text-sm">Ausgeschlossene Partner werden berücksichtigt</p>
                <p className="text-slate-500 text-xs mt-0.5">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-semibold text-slate-800 text-sm">Imperoyal wird benachrichtigt</p>
                <p className="text-slate-500 text-xs mt-0.5">
            ...
            <div className="flex gap-3">
              <div className="w-9 h-9 rounded-xl bg-purple-50 flex items-center justify-center flex-shrink-0">
                <Handshake className="w-4.5 h-4.5 text-purple-600" />
              </div>
              <div>
                <p className="font-semibold text-slate-800 text-sm">Keine Verpflichtung</p>
                <p className="text-slate-500 text-xs mt-0.5">
          ...
          <div className="p-3 rounded-xl bg-blue-50 border border-blue-100">
            <p className="text-blue-700 text-xs leading-relaxed">
              <strong>Hinweis:</strong> Ihre Kontaktdaten werden erst nach Ihrer ausdrücklichen 
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 sm:justify-end pt-2">
            <button
              ...
              className="px-4 py-3 sm:py-2.5 text-slate-600 hover:bg-slate-100 rounded-lg transition-colors min-h-[44px] text-center text-sm"
            >
              Abbrechen
            </button>
            <button
              ...
              disabled={loading}
              className="px-5 py-3 sm:py-2.5 bg-[#22c55e] hover:bg-[#16a34a] text-white rounded-lg transition-colors min-h-[44px] text-sm font-medium flex items-center justify-center gap-2"
            >
              {loading ? (
